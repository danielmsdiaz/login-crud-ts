                            ...
                            props.personais.map((person) => (
                                <li key={person.email} className="flex flex-col sm:flex-row justify-between gap-6 py-4">
                                    <div className="flex min-w-0 gap-x-4">
                                        <img alt="" src={person.imageUrl} className="h-16 w-16 flex-none rounded-full bg-gray-50" />
                                        <div className="min-w-0 flex-auto">
                                            ...
                                            <p className="mt-1 text-xs leading-5 text-gray-500">{person.specializations.join(', ')}</p>
                                        </div>
                                    </div>
                                    <div className="flex-none flex flex-col sm:items-end">
                                        ...
                                        <button className="mt-2 text-xs font-semibold text-blue-500 hover:underline">Detalhes</button>
                                    </div>
                                </li>
                            ))
                        }
