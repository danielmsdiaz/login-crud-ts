                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form className="md:space-y-6" onSubmit={handleSubmit(handleFormSubmit)} action="">
                            <div className='space-y-4 md:space-y-2'>
                                <Label>Email:</Label>
                                <Input defaultValue="" control={control} name="email" rules={{ required: true }} />
                            </div>
                            <div className='space-y-4 md:space-y-2'>
                                <Label>Senha:</Label>
                                <Input defaultValue="" control={control} name="password" rules={{ required: true}} />
                            </div>
